...
- Follow moving main silently
- Defer the decision or make no change
- The selected bounded option

## Decision

Pin exact official commits and recheck before submission.

## Consequences

Contest infrastructure can change during the sprint.
