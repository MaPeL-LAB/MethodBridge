...
- Use full advertised context
- Target the exact 7 GB ceiling
- The selected bounded option

## Decision

Use an internal ≤6.0 GB peak-RSS target and conservative context.

## Consequences

Retains audit-variance and process-overhead headroom.
